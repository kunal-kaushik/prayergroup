...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create blues-stack-de64
  fly apps create blues-stack-de64-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blues-stack-de64
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blues-stack-de64-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'blues-stack-de64-staging' does not match app name in config file 'blues-stack-de64'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name blues-stack-de64-db
  fly postgres attach --app blues-stack-de64 blues-stack-de64-db

  fly postgres create --name blues-stack-de64-staging-db
  fly postgres attach --app blues-stack-de64-staging blues-stack-de64-staging-db
  ```
